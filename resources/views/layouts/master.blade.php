              ...
              <div class="dropdown dropdown-user-setting">
                <a class="dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                  <div class="user-setting d-flex align-items-center gap-2">
					...
					<i class="fa fa-user fa-2x" style="width:45px;height:45px;border-radius:50%;border:1px solid #c4c4c4;padding:6px 9px;"></i>
					
                    <div class="d-none d-sm-block">
                       <p class="user-name mb-0" title="{{Auth::user()->shop_name}}">{{substr(Auth::user()->shop_name,0,8)}}</p>
                    </div>
                  </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
				
					<li style="margin:0px;padding:0px;line-height:20px;"><span style="margin-left:10px;font-size:13px;">Id: {{Auth::user()->pk_user_id}}</span> </li>
